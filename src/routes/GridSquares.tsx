import { Box, Heading, HStack, VStack, CardBody, Card, CardHeader, Image } from "@chakra-ui/react";
...
const GridSquares = () => {
  ...
  console.log("grid squares", gridSquares, typeof gridSquares, gridSquares.length);
  ...
  const res =
    <div className="rootContainer">
      <Box w="100%" bg="murfey.50" >
        ...
        <Box mt="1em" ml="1em" w="95%" justifyContent={"center"} alignItems={"center"}>
          {(gridSquares && gridSquares.length > 0) ? gridSquares.map((gs) => 
