...
import { MultigridSetup } from 'utils/MultigridSetup'
    ...
    },
    {
        ...
        children: [
            ...
            },
            {
                ...
                errorElement: <Error />,
                loader: ({ params }) =>
                    processingParametersLoader(queryClient)(params),
            },
            {
                ...
                errorElement: <Error />,
                loader: ({ params }) =>
                    sessionParametersLoader(queryClient)(params),
            },
            {
                path: '/mag_table',
                element: <MagTable />,
            ...
            },
            {
                ...
                errorElement: <Error />,
                loader: ({ params }) =>
                    dataCollectionGroupsLoader(queryClient)(params),
            },
            {
