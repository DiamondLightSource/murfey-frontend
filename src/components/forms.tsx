import { Divider, Text, FormControl, FormLabel, Input, NumberInput, NumberInputField, NumberInputStepper, NumberIncrementStepper, NumberDecrementStepper, RadioGroup, Radio, HStack, VStack, Select, Switch } from "@chakra-ui/react";
...
const SpaForm = () => {
    ...
    return (
        <FormControl>
            ...
            <NumberInput defaultValue={1} min={1} isValidCharacter={validateInt} isDisabled={['T', 'O'].includes(symmetryType)}>
                <NumberInputField />
                <NumberInputStepper>
            ...
            <HStack>
                ...
                <Switch defaultChecked colorScheme="murfey" onChange={handleSwitchChange} />
            </HStack>
            </VStack>
            {!particleDetection ? <VStack align='start' width='100%'><FormLabel>{"Particle diameter [\u212B]"}</FormLabel><Input defaultValue={200} /></VStack>: <></>}
            <VStack align='start' width='100%'>
            <HStack>
